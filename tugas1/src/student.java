...
public class student {
    ...
    static void displaybooks(){
        System.out.println("==================================================================================================================================");
        System.out.printf("|| %-3s || %-25s || %-25s || %-25s || %-20s || %-3s ||", "No.", "ID Buku", "Nama Buku", "Author", "Category", "Stock");
        System.out.println("==================================================================================================================================");

        for(Main.book i : Main.booklist){
            System.out.printf("|| %-3s || %-25s || %-25s || %-25s || %-20s || %-3s ||", i.no, i.id, i.namabuku, i.author, i.category, i.stock);
        }
